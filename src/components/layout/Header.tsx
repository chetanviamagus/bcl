...
import BCLogo from '@/assets/images/bcl-logo.png'
        ...
        <div className="flex justify-between items-center h-16">
                  ...
                  >
                    {item.children.map((child) => (
                      <Link
                        key={child.href}
                        to={child.href}
                        className="block px-4 py-2 text-gray-700 hover:bg-gray-50 hover:text-primary-green transition-colors duration-200"
                        style={{ fontSize: '13px', fontFamily: '"Work Sans", sans-serif' }}
                      >
                        {child.label}
                      </Link>
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gold hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gold"
              aria-expanded="false"
            >
